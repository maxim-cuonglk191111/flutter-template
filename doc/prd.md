# Product Requirements Document: Flutter Core 
...
- **API Keys:** Không hardcode API keys trong source; dùng Remote Config hoặc environment
...
/core_template
  /lib
    ...
    /shared_ui
      ...
      /cards
      /dialogs
      /theme              ← AppTheme, color tokens, dark mode
    /features
...
- **Network:** Dio
- **Design System:** Custom theme system dựa trên Material 3; token màu trong 1 file
...
- Settings (dark mode, privacy policy, restore purchase)
